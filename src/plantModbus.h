...
#include <MgsModbus.h> // change memory size here
...
#define HW_PY_002_OFP_SP 30 // Drain Pump OFF Period in sec  Setpoint
#define HW_PY_002_ONP_SP 31 // Drain Pump ON Period in sec  Setpoint
