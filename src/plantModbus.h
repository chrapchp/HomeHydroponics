...
#define HR_LT_002   14        // Water Level present value in cm from top,  0->
                              // undefined
...
#define HW_DY_102_ONT_SP   30 // Seeding Area Chamber LED ON Time (UNIX EPOCH)
                              // Setpoint UTC
#define HW_DY_102_OFT_SP   32 // Seeding Area LED OFF Time  (UNIX EPOCH)
                              //  Setpoint UTC time
#define HW_DY_103_ONT_SP   34 // Growing Chamber LED ON Time (UNIX EPOCH)
                              //  Setpoint UTC time
#define HW_DY_103_OFT_SP   36 // Growing Chamber LED OFF Time  (UNIX EPOCH)
                              //  Setpoint UTC time
...
#define HW_PY_001_ONP_SP   42 // Circulation Pump 120VAC ON Period in sec
                              //  Setpoint
#define HW_PY_001_OFP_SP   43 // Circulation Pump 120VAC OFF Period in sec
                              //  Setpoint


#define HR_DY_102_ONT_CV   44 // Seeding Area Chamber LED ON Time (UNIX EPOCH)
                              // Current Value UTC
#define HR_DY_102_OFT_CV   46 // Seeding Area LED OFF Time  (UNIX EPOCH)
                              //  Current Value  UTC
#define HR_DY_103_ONT_CV   48 // Growing Chamber LED ON Time (UNIX EPOCH)
                              //  Current Value UTC
#define HR_DY_103_OFT_CV   50 // Growing Chamber LED OFF Time  (UNIX EPOCH)
                              //  Current Value UTC
...
#define HR_PY_001_ONP_CV   54 // Circulation Pump 120VAC ON Period in sec
                              //  Current Value
#define HR_PY_001_OFP_CV   55 // Circulation Pump 120VAC OFF Period in sec
                              //  Current Value
